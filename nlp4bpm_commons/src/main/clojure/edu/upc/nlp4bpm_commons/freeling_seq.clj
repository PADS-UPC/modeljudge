...
(def aliases
  ...
  {"edu.upc.freeling.Document" "edu.upc.freeling.ListParagraph"
   "edu.upc.freeling.Paragraph" "edu.upc.freeling.ListSentence"
...
(defn- get-list-constructor [list-type]
  (let [constructor (.getConstructor
                     (Class/forName (str "edu.upc.freeling." (typename list-type)))
...
(defn seq->fl [[x & xs :as lst]]
  ...
  ;; edu.upc.freeling prefix, but their list type will always
  ;; be in that package.
